        ...
        <AnimatePresence>
          {quoteModalOpen && (
            ...
            >
              ...
              />
              <motion.div
                className="relative bg-card border border-yellow-400/50 rounded-xl shadow-2xl p-6 w-full max-w-md pointer-events-auto"
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button onClick={() => setQuoteModalOpen(false)} className="text-muted-foreground hover:text-foreground">
                    <X className="h-5 w-5" />
                  </button>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    <label htmlFor="modal-name" className="text-sm font-medium">Name</label>
                    <Input id="modal-name" placeholder="Your full name" className="mt-1" />
                  </div>
                  <div>
                    <label htmlFor="modal-phone" className="text-sm font-medium">Phone</label>
                    <Input id="modal-phone" placeholder="Your phone number" className="mt-1" />
                  </div>
                  <div>
                    <label htmlFor="modal-email" className="text-sm font-medium">Email</label>
                    <Input id="modal-email" type="email" placeholder="your@email.com" className="mt-1" />
                  </div>
                  <div>
                    <label htmlFor="modal-message" className="text-sm font-medium">Message</label>
                    <Textarea id="modal-message" placeholder="Tell us about your project requirements..." className="mt-1 min-h-[80px]" />
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4 p-4 rounded-lg bg-secondary/30 border border-border">
                    ...
                    <div className="flex-1">
                      ...
                      <a href="tel:8887956464" className="text-primary hover:text-primary/80 font-medium">+91 88879 56464</a>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 p-4 rounded-lg bg-secondary/30 border border-border">
                    <div className="w-10 h-10 rounded-full bg-primary flex items-center justify-center">
                    ...
                    <div className="flex-1">
                      ...
                      <a href="tel:8855995591" className="text-primary hover:text-primary/80 font-medium">+91 88559 95591</a>
                    </div>
                  </div>
                </div>
